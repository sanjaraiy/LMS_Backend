...
router
    .route('/razorpay-key')
    .get(isLoggedIn, getRazorpayApiKeyHandler)

router
    .route('/subscribe')
    .post(isLoggedIn, buySubscriptionHandler)

router
    .route('/verify')
    .post(isLoggedIn, verifySubscriptionHandler)

router
    .route('/unsubscribe')
    .post(isLoggedIn, cancelSubscriptionHandler)

router 
    .route('/')
    .get(isLoggedIn, authorizedRoles('ADMIN'), allPaymentsHandler)
